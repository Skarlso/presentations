...
This is a talk about the design process that I went through while building high performance JSON parser.
...
The alternative is an idea inspired by Steven Schveighoffer's iopipe footnote:[https://www.youtube.com/watch?v=un-bZdyumog] and Phil Pearl footnote:[https://philpearl.github.io/post/reader/] which I adapted into a type called a `byteReader`.
...
.Click to see why is is the fastest general purpose whitespace counter
[%collapsible]
====
...
[source,go,options="nowrap"]
----
include::json/decoder4.go[tags=before]
----
...
----
Elimininating the cost of the function call.
...
N allocations per token or per byte can be the limiting constraint. You're benchmarking the garbage collector at that point.
...
- Link to this presentation: https://dave.cheney.net/paste/gophercon-sg-2023.html qrcode:https://dave.cheney.net/paste/gophercon-sg-2023.html[svg, xdim=4]
